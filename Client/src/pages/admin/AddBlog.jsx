...
const AddBlog = () => {
  ...
  <div className='w-9 h-9 rounded-full border-2 border-t-white animate-spin'></div>
</div>
)}
            <button disabled ={loading}type='button' onClick={generateContent}  className='absolute bottom-1 right-2 ml-2 text-white bg-black/70 px-4 py-1.5 rounded 
            hover:underline cursor-pointer'>Generative with AI</button>
